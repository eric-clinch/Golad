...
struct BirthRandSearch::ABMArgs {
	Board *board;
	Player playerID;
	Player enemyID;
	int time;
...
Move BirthRandSearch::getRandomMove(vector<MoveType> &availableMoveTypes, vector<Coordinate> &deadCells, vector<Coordinate> &myCells, vector<Coordinate> &enemyCells) {
...
double BirthRandSearch::evaluateBoardMini(Board &board, int depth, Data &data, double alpha, double beta) {
	assert(alpha < beta);
...
double BirthRandSearch::evaluateBoardMaxi(Board &board, int depth, Data &data, double alpha, double beta) {
	assert(alpha < beta);
	Board *trialBoard = data.trialBoards[depth];
	Board *nextRoundBoard = data.nextRoundBoards[depth];
	LinkedList<Move> *killerMoves = data.killerMovesByRound[depth];
...
inline double BirthRandSearch::getMoveScoreMini(Board &board, Move &move, Board &nextRoundBoard, Board &trialBoard,
...
inline double BirthRandSearch::getMoveScoreMaxi(Board &board, Move &move, Board &nextRoundBoard, Board &trialBoard,
	int depth, Data &data, double alpha, double beta) {
	assert(alpha < beta);
...
BirthRandSearch::MoveAndScore BirthRandSearch::getBestKillMove(Board &board, vector<Coordinate> &enemyCells,
...
BirthRandSearch::MoveAndScore BirthRandSearch::getBestBirthMove(Board &board, vector<Coordinate> &deadCellsVect,
...
void *BirthRandSearch::approximateBestMove(void *voidArg) {
	long startTime = Tools::get_time();
